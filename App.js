...
export default function App() {
  return (
    <Container>
        <PatientList title="16th of September" items={[
            {
                id: 1,
                timeVisit: '12:30',
